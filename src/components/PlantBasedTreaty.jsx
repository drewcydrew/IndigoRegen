    ...
    <div className="plant-based-treaty-container" style={{ 
      ...
      <div className="intro-section" style={{ 
        ...
        <p style={{ 
          ...
          at the centre of combating the climate crisis. The Plant Based Treaty addresses 
          emissions from animal agriculture and promotes the shift to plant based food 
          systems as a critical solution to climate change.
        </p>
      </div>
